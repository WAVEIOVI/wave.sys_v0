...
const TableOfContents: React.FC<{ isDark?: boolean }> = ({ isDark }) => {
    return (
        <IsoSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <GlassCard className="p-6">
                    <h3 className="text-blue-600 text-xs uppercase tracking-widest mb-4">Section 3: SERVICE STANDARDS</h3>
                    <ul className="space-y-3 text-sm font-medium opacity-80">
                        <li>3.1 Customer Service Commitments</li>
                        <li>3.2 Response Time Standards</li>
                        <li>3.3 Technical Service Standards</li>
                        <li>3.4 Quality Guarantees & Warranties</li>
                        <li>3.5 Complaint Resolution</li>
                    </ul>
                </GlassCard>

                <GlassCard className="p-6 border-l-4 border-l-blue-500/50">
                    <h3 className="text-blue-600 text-xs uppercase tracking-widest mb-4">Section 4: KEY BUSINESS RULES</h3>
                    <ul className="space-y-3 text-sm font-medium opacity-80">
                        <li>4.1 Pricing Guidelines</li>
                        <li>4.2 Discount Authority</li>
                        <li>4.3 Payment Terms & Credit Policy</li>
                        <li>4.4 Travel Fees Policy</li>
                        <li>4.5 Warranty & Returns Policy</li>
                        <li>4.6 Risk Management - When We Say "No"</li>
                    </ul>
                </GlassCard>
            </div>
        </IsoSection>
